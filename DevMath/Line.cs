...
namespace DevMath
{
    public class Line
    {
        ...
        public bool IntersectsWith(Vector2 point)
        {
            ...
            return (distanceBeginning + distanceEnd <= Length + 0.001f && distanceBeginning + distanceEnd >= Length - 0.001f) ? true : false; //float.Epsilon werkt hier niet. Is te klein. Thanks naar Wessel.
        }
